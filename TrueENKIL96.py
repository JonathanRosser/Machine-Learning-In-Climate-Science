...
while count<ITER:
	    ...
	    Cpp=CppSOP/Q
            ...
            yrand=np.zeros((Q,N))
            yrand[:,:]=ztrue[M:M+N]+np.random.normal(loc=0.0,scale=np.sqrt(np.diag(Gamma)),size=(Q,N))
...
print(end-start)
np.save("/home/jprosser/Documents/WorkPlacements/Caltech/Data/TrueENKI/timestepx0r00001sample3.npy",end-start)

np.save("/home/jprosser/Documents/WorkPlacements/Caltech/Data/TrueENKI/TrueENKIparameters400x4x0r00001sample3.npy",parameters)
np.save("/home/jprosser/Documents/WorkPlacements/Caltech/Data/TrueENKI/TrueENKIOutput400x4x0r00001sample3.npy", Output)
