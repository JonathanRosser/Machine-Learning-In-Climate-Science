...
ITER=100000
burnin=20000
samples=np.zeros((2,ITER+burnin,chains,M))
...
gpmake(np.transpose(XFULLENKI),np.transpose(YFULLENKI),'FULLENKI')
PRI=0
samples[0,:,:]=MCMC(ModelNames[5],chains,ITER,burnin)
np.save("/home/jprosser/Documents/WorkPlacements/Caltech/Data/Combined/GPMCMCFULLENKISAMPLES.npy",samples[0,:,:])


PRI=1
samples[1,:,:]=MCMC(ModelNames[5],chains,ITER,burnin)
np.save("/home/jprosser/Documents/WorkPlacements/Caltech/Data/Combined/GPMCMCFULLENKISAMPLESUniformPrior.npy",samples[1,:,:])
