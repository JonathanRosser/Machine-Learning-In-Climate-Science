...
NumTrains=1 #Number of training methods
...
for SAMPLE in range(0,NumSamples):
        ...
        XENKI=np.transpose(np.load("/home/jprosser/Documents/WorkPlacements/Caltech/Data/ENFlow/ENFlowparameters400x4sample{}.npy".format(SAMPLE)))
        YENKI=np.transpose(np.load("/home/jprosser/Documents/WorkPlacements/Caltech/Data/ENFlow/ENFlowOutput400x4sample{}.npy".format(SAMPLE)))
        ...
        np.save("/home/jprosser/Documents/WorkPlacements/Caltech/Data/Combined/ENFlowGPMCMCsamples.npy",samples)
