...
samples[:initial_size,:,:]=np.load("/home/jprosser/Documents/WorkPlacements/Caltech/Data/L96sampleschain2i59000.npy")[:initial_size,:,:]
...
for i in range(initial_size,ITER+burnin+initial_size):
    ...
    if i%1000==0:
	np.save("/home/jprosser/Documents/WorkPlacements/Caltech/Data/L96sampleschain2.npy".format(i),samples)
