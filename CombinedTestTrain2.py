...
####New GP test outputs
GPsamples=np.load("/home/jprosser/Documents/WorkPlacements/Caltech/Data/Combined/GaussianGPSAMPLES.npy")[2000:,:,:].reshape((100000,4))
GPmeans=np.mean(GPsamples,axis=0)
GPstds=np.std(GPsamples,axis=0)
GPGaussx=np.random.normal(loc=GPmeans,scale=GPstds,size=(Ntest,M))
GPGaussy=yfromx(GPGaussx,Ntest)
normerrorcalc(GPGaussx,GPGaussy,12)
np.save("/home/jprosser/Documents/WorkPlacements/Caltech/Data/Combined/GPGaussxtest.npy",GPGaussx)
np.save("/home/jprosser/Documents/WorkPlacements/Caltech/Data/Combined/GPGaussytest.npy",GPGaussy)


####Output NormError
np.save("/home/jprosser/Documents/WorkPlacements/Caltech/Data/Combined/NormError2.npy",NormError)
